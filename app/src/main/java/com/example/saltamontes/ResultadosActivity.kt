...
class ResultadosActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(miBundle != null){
            ...
            campoTelefono.text="Telefono: ${miBundle.getString("Telefono")} "
            ...
            campoPromedio.text="Su promedio del periodo es: ${miBundle.getDouble("Promedio")} "
            campoResultado.text="Resultado: ${miBundle.getString("Mensaje")} "
        }else{
